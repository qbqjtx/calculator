...
public class ExpTree {
    ...
    // @Nullable ExpTree left, @NotNull Expression self, @Nullable ExpTree right
    public ExpTree(ExpTree left, Expression self, ExpTree right) {
        this.left = left;
        this.right = right;
        this.self = self;
    ...
    // NotNull self
    public ExpTree(Expression self) {
        this.self = self;
        this.left = null;
        this.right = null;
    }
